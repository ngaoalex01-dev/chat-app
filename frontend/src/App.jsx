...
function App () {
  ...
  const showDecorators = !authUser || !isMobile;
  ...
  return (
    ...
    <div className={`min-h-screen bg-slate-900 relative flex ${authUser && isMobile ? "" : "items-center justify-center"} overflow-hidden`}>
      {showDecorators && (
        <>
